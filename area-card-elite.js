      ...
      <ha-card class="${this._config.display_type||"compact"} layout-${n} features-${a}">
        <div class="content">
          ...
          ${"icon"===this._config.display_type&&c?F`
            <div class="main-entity-background ${!l||"locked"!==l.state&&Te.includes(l.state)?"":"active"} 
              ${l&&("unlocked"===l.state||Te.includes(l.state))?"unlocked":""}">
              <ha-icon 
