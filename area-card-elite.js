...
/**
    ...
    `}_renderSensors(){if(!this._config)return q;const e=[];if(this._config.temperature_entity&&this.hass.states[this._config.temperature_entity]){const i=this.hass.states[this._config.temperature_entity];if(!De.includes(i.state)){const o=parseFloat(i.state),s=Le(o),a=null==(t=o)?{icon:"mdi:thermometer",animate:!1}:t>=80?{icon:"mdi:fire",animate:!0}:t>=75?{icon:"mdi:weather-sunny",animate:!1}:t>=70?{icon:"mdi:thermometer",animate:!1}:t>=65?{icon:"mdi:thermometer-check",animate:!1}:t>=60?{icon:"mdi:thermometer",animate:!1}:{icon:"mdi:snowflake",animate:!0};e.push({icon:a.icon,value:this.hass.formatEntityState(i),deviceClass:"temperature",color:s.color,animate:a.animate})}}var t;if(this._config.humidity_entity&&this.hass.states[this._config.humidity_entity]){const t=this.hass.states[this._config.humidity_entity];De.includes(t.state)||e.push({icon:"mdi:water-percent",value:this.hass.formatEntityState(t),deviceClass:"humidity",color:"#2196f3"})}if(this._config.illuminance_entity&&this.hass.states[this._config.illuminance_entity]){const t=this.hass.states[this._config.illuminance_entity];De.includes(t.state)||e.push({icon:"mdi:brightness-6",value:this.hass.formatEntityState(t),deviceClass:"illuminance",color:"#ffeb3b"})}if(this._config.power_entity&&this.hass.states[this._config.power_entity]){const t=this.hass.states[this._config.power_entity];De.includes(t.state)||e.push({icon:"mdi:flash",value:this.hass.formatEntityState(t),deviceClass:"power",color:"#ff9800"})}if(this._config.energy_entity&&this.hass.states[this._config.energy_entity]){const t=this.hass.states[this._config.energy_entity];De.includes(t.state)||e.push({icon:"mdi:lightning-bolt",value:this.hass.formatEntityState(t),deviceClass:"energy",color:"#9c27b0"})}if(this._config.battery_entity&&this.hass.states[this._config.battery_entity]){const t=this.hass.states[this._config.battery_entity];if(!De.includes(t.state)){const i=Number(t.state);let o="mdi:battery",s="#4caf50";isNaN(i)||(i<=10?(o="mdi:battery-outline",s="#f44336"):i<=20?(o="mdi:battery-20",s="#ff5722"):i<=50?(o="mdi:battery-50",s="#ff9800"):(o="mdi:battery",s="#4caf50")),e.push({icon:o,value:this.hass.formatEntityState(t),deviceClass:"battery",color:s})}}return 0===e.length?q:F`
      <div class="sensors">
        ${e.map((e=>F`
          <div class="sensor">
    ...
    `:q}_handleControlClick(e){this._handleEntityClick(e)}_handleEntityClick(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}_getAreaCameras(){var e;return(null===(e=this._config)||void 0===e?void 0:e.area)?Object.entries(this.hass.states||{}).filter((([e,t])=>{var i,o;const[s]=e.split(".");return"camera"===s&&(null===(i=t.attributes)||void 0===i?void 0:i.area_id)===(null===(o=this._config)||void 0===o?void 0:o.area)})).map((([e,t])=>({entityId:e,name:t.attributes.friendly_name||e.split(".")[1]}))):[]}_getAreaName(){var e,t,i;if(null===(e=this._config)||void 0===e?void 0:e.name)return this._config.name;const o=this._areas[(null===(t=this._config)||void 0===t?void 0:t.area)||""];return(null==o?void 0:o.name)||(null===(i=this._config)||void 0===i?void 0:i.area)||"Unknown Area"}_getAreaIcon(){var e,t;if(null===(e=this._config)||void 0===e?void 0:e.icon)return this._config.icon;const i=this._areas[(null===(t=this._config)||void 0===t?void 0:t.area)||""];return(null==i?void 0:i.icon)||"mdi:home"}_getAreaFilteredEntities(e,t){var i;return(null===(i=this._config)||void 0===i?void 0:i.area)?Object.entries(this.hass.states||{}).filter((([i,o])=>{var s,a;const[n]=i.split(".");return n===e&&((!t||o.attributes.device_class===t)&&(null===(s=o.attributes)||void 0===s?void 0:s.area_id)===(null===(a=this._config)||void 0===a?void 0:a.area))})).map((([e])=>e)):[]}_isEntityActive(e){var t;if(!e)return!1;const i=e.entity_id.split(".")[0];if(De.includes(e.state))return!1;if("lock"===i)return"locked"===e.state;if("binary_sensor"===i){const i=null===(t=e.attributes)||void 0===t?void 0:t.device_class;if("door"===i||"window"===i||"opening"===i)return"off"===e.state||"closed"===e.state}return"cover"===i?"closed"===e.state:!Be.includes(e.state)}render(){var e,t,i,o;if(!this.hass||!this._config)return q;const s=this._getAreaName(),a=this._getAreaIcon(),n=this._config.area_name_color?`color: ${this._config.area_name_color};`:"",r=this._config.area_icon_color?`color: ${this._config.area_icon_color};`:"",c={active:{color:(null==(l=this._config)?void 0:l.state_active_color)||"#4caf50",rgb:Re((null==l?void 0:l.state_active_color)||"#4caf50")},inactive:{color:(null==l?void 0:l.state_inactive_color)||"#607d8b",rgb:Re((null==l?void 0:l.state_inactive_color)||"#607d8b")}};var l;const d=this._getActiveAlertInfo();let h,u;if(this._config.temperature_entity&&this.hass.states[this._config.temperature_entity]){const e=this.hass.states[this._config.temperature_entity].state;h=parseFloat(e),isNaN(h)&&(h=void 0)}if(this._config.humidity_entity&&this.hass.states[this._config.humidity_entity]){const e=this.hass.states[this._config.humidity_entity].state;u=parseFloat(e),isNaN(u)&&(u=void 0)}const p=Le(h),f=function(e){return null==e?.15:e>=70?.25:e>=60?.2:e>=40?.15:.12}(u),g=(null===(e=this._config)||void 0===e?void 0:e.occupancy_sensor)&&this.hass.states[this._config.occupancy_sensor]?this.hass.states[this._config.occupancy_sensor]:null,m="on"===(g?g.state:void 0),_=(null===(t=this._config)||void 0===t?void 0:t.occupancy_display)||"auto",v="count"===_||"auto"===_,y=(null===(i=this._config)||void 0===i?void 0:i.occupancy_color)||"#ffffff",b=$e(Object.assign({"--state-active-color":c.active.color,"--state-active-rgb":c.active.rgb,"--state-inactive-color":c.inactive.color,"--state-inactive-rgb":c.inactive.rgb,"--alert-color":d.color,"--alert-rgb":d.rgb,"--temp-color":p.color,"--temp-rgb":p.rgb,"--humidity-intensity":f.toString()},this._config.color&&{backgroundColor:this._config.color})),$=this._config.layout||"compact",x=this._config.features_position||"bottom",w=null===(o=this._config.features)||void 0===o?void 0:o.includes("area-controls"),A=this._config.main_entity?this.hass.states[this._config.main_entity]:null;return F`
      <ha-card class="${this._config.display_type||"compact"} layout-${$} features-${x} ${m?"occupied":""}" style=${b}>
        <div class="content">
          <!-- Large background entity icon - ONLY for icon display type -->
          ${"icon"===this._config.display_type&&A?F`
            <!-- Separate circle background -->
            <div class="main-entity-circle ${this._isEntityActive(A)?"active":"inactive"} ${this._hasActiveAlerts()?"has-alert":""}">
            </div>
            ...
            <div class="main-entity-icon"
              ...
              <ha-icon
                icon="${this._getDomainIcon(A.entity_id.split(".")[0],A.state,A.attributes.device_class)}">
              </ha-icon>
            </div>
          `:q}
          ...
          <div class="area-info">
            ${"vertical"===$||"compact"!==this._config.display_type?F`
            ...
            <div class="area-details">
              <div class="area-name" style="${n}">
                ...
                ${v&&g?F`
                  <span class="occupancy-indicator" title="${m?"Occupied":"Not occupied"}">
                    <ha-icon icon="mdi:account" style="color: ${y}; --mdc-icon-size: 14px"></ha-icon>
