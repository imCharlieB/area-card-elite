          ...
          <div class="content">
            ...
            ${"picture"===this._config.display_type?F`
              <div class="option">
                <ha-selector
                  .hass=${this.hass}
                  .selector=${{media:{filter:{supported_formats:["image"]}}}}
