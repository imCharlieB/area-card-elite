...
/**
    ...
    `}_handleMoreInfo(){var e;const t=new CustomEvent("hass-more-info",{detail:{entityId:`area.${null===(e=this._config)||void 0===e?void 0:e.area}`},bubbles:!0,composed:!0});this.dispatchEvent(t)}_handleToggleAll(){const e=this._getAreaEntities().filter((e=>Re.includes(e.domain)));e.forEach((e=>{this.hass.callService(e.domain,"toggle",{},{entity_id:e.entityId})}))}_handleTurnOffAllLights(){var e;const t=this._getAreaEntities().filter((e=>"light"===e.domain));t.forEach((e=>{this.hass.callService("light","turn_off",{},{entity_id:e.entityId})})),(null===(e=this._config)||void 0===e?void 0:e.light_entity)&&this.hass.states[this._config.light_entity]&&this.hass.callService("light","turn_off",{},{entity_id:this._config.light_entity})}_hexToRgb(e){const t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?`${parseInt(t[1],16)}, ${parseInt(t[2],16)}, ${parseInt(t[3],16)}`:"76, 175, 80"}static getConfigElement(){return document.createElement("area-card-elite-editor")}static getStubConfig(){return{area:""}}};var De,Be;He.styles=r`
    ha-card {
      overflow: hidden;
      position: relative;
      height: 100%;
