        ...
        <div class="content">
          ...
          ${"icon"===this._config.display_type&&O?F`
            ...
            <div class="main-entity-icon"
              ...
              <ha-icon
                icon="${this._getDomainIcon(O.entity_id.split(".")[0],O.state,O.attributes.device_class)}">
              </ha-icon>
            </div>
          `:q}
          ...
          <div class="area-info">
            ${"vertical"===k||"compact"!==this._config.display_type?F`
