...
/**
    ...
    `:W}_renderSensors(){if(!this._config)return W;const e=[];if(this._config.temperature_entity&&this.hass.states[this._config.temperature_entity]){const t=this.hass.states[this._config.temperature_entity];Te.includes(t.state)||e.push({icon:"mdi:thermometer",value:this.hass.formatEntityState(t),deviceClass:"temperature"})}if(this._config.humidity_entity&&this.hass.states[this._config.humidity_entity]){const t=this.hass.states[this._config.humidity_entity];Te.includes(t.state)||e.push({icon:"mdi:water-percent",value:this.hass.formatEntityState(t),deviceClass:"humidity"})}if(this._config.illuminance_entity&&this.hass.states[this._config.illuminance_entity]){const t=this.hass.states[this._config.illuminance_entity];Te.includes(t.state)||e.push({icon:"mdi:brightness-6",value:this.hass.formatEntityState(t),deviceClass:"illuminance"})}if(this._config.power_entity&&this.hass.states[this._config.power_entity]){const t=this.hass.states[this._config.power_entity];Te.includes(t.state)||e.push({icon:"mdi:flash",value:this.hass.formatEntityState(t),deviceClass:"power"})}if(this._config.energy_entity&&this.hass.states[this._config.energy_entity]){const t=this.hass.states[this._config.energy_entity];Te.includes(t.state)||e.push({icon:"mdi:lightning-bolt",value:this.hass.formatEntityState(t),deviceClass:"energy"})}if(this._config.battery_entity&&this.hass.states[this._config.battery_entity]){const t=this.hass.states[this._config.battery_entity];if(!Te.includes(t.state)){const i=Number(t.state);let o="mdi:battery";isNaN(i)||(o=i<=10?"mdi:battery-outline":i<=20?"mdi:battery-20":i<=30?"mdi:battery-30":i<=40?"mdi:battery-40":i<=50?"mdi:battery-50":i<=60?"mdi:battery-60":i<=70?"mdi:battery-70":i<=80?"mdi:battery-80":i<=90?"mdi:battery-90":"mdi:battery"),e.push({icon:o,value:this.hass.formatEntityState(t),deviceClass:"battery"})}}return 0===e.length?W:q`
      <div class="sensors">
        ${e.map((e=>q`
          <div class="sensor">
  ...
  `,t([pe({attribute:!1})],Ne.prototype,"hass",void 0),t([fe()],Ne.prototype,"_config",void 0),t([fe()],Ne.prototype,"_areas",void 0),Ne=t([de("area-card-elite")],Ne),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(Re||(Re={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(He||(He={}));var ze=function(e,t,i,o){o=o||{},i=null==i?{}:i;var s=new Event(t,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});return s.detail=i,e.dispatchEvent(s),s};let Ve=class extends le{constructor(){super(...arguments),this._areas=[],this._localImages=[]}async connectedCallback(){super.connectedCallback(),await this._loadAreas(),await this._loadLocalImages()}async _loadAreas(){var e;try{if(null===(e=this.hass)||void 0===e?void 0:e.connection){const e=await this.hass.connection.sendMessagePromise({type:"config/area_registry/list"});this._areas=e||[]}}catch(e){console.error("Failed to load areas:",e),this._areas=[]}}async _loadLocalImages(){try{const e=await this.hass.connection.sendMessagePromise({type:"media_player/browse_media",media_content_id:"media-source://media_source/local",media_content_type:"app"});this._localImages=this._extractImagePaths(e)}catch(e){console.error("Failed to load local images:",e),this._localImages=[]}}_extractImagePaths(e){const t=[];return(null==e?void 0:e.children)&&e.children.forEach((e=>{var i,o;if(null===(i=e.media_content_type)||void 0===i?void 0:i.startsWith("image/")){const i=null===(o=e.media_content_id)||void 0===o?void 0:o.replace("media-source://media_source/local/","/local/");i&&t.push(i)}})),t}setConfig(e){this._config=Object.assign({features:[],display_type:"compact",color:"",aspect_ratio:"16:9",camera_view:"auto",navigation_path:"",alert_classes:[],sensor_classes:[],features_position:"bottom",exclude_entities:[],layout:"vertical"},e)}_valueChanged(e){var t;if(e.stopPropagation(),!this._config)return;const i=e.target;let o=null===(t=e.detail)||void 0===t?void 0:t.value,s=i.configValue;console.log("Value changed:",{type:e.type,tagName:i.tagName,configValue:s,value:o,detail:e.detail}),null==o&&("input"===e.type&&void 0!==i.value||void 0!==i.value)&&(o=i.value),"HA-AREA-PICKER"===i.tagName?s="area":"HA-ENTITY-PICKER"===i.tagName&&(s=i.configValue||"exclude_entities"),s&&void 0!==o&&(console.log("Setting config:",s,"=",o),this._config=Object.assign(Object.assign({},this._config),{[s]:o}),ze(this,"config-changed",{config:this._config}),this.requestUpdate())}_getDeviceClasses(e){var t;if(!(null===(t=this._config)||void 0===t?void 0:t.area))return[];const i=Object.entries(this.hass.states||{}).filter((([t,i])=>{var o,s;return!!(null===(o=i.attributes)||void 0===o?void 0:o.area_id)&&(i.attributes.area_id===(null===(s=this._config)||void 0===s?void 0:s.area)&&t.split(".")[0]===e)})).map((([e,t])=>t)),o=i.map((e=>e.attributes.device_class||"")).filter((e=>e));return[...new Set(o)]}_buildSelectOptions(e){const t=this._getDeviceClasses(e);let i=[];return i="binary_sensor"===e?[...new Set([...t,...Ie.binary_sensor])]:"sensor"===e?[...new Set([...t,...Ie.sensor])]:t,i.map((t=>({value:t,label:this.hass.localize(`component.${e}.device_class.${t}`)||this.hass.localize(`ui.dialogs.entity_registry.editor.device_classes.${e}.${t}`)||t.charAt(0).toUpperCase()+t.slice(1).replace(/_/g," ")})))}render(){if(!this.hass||!this._config)return W;const e=this._buildSelectOptions("binary_sensor"),t=Ie.sensor.map((e=>({value:e,label:this.hass.localize(`ui.dialogs.entity_registry.editor.device_classes.sensor.${e}`)||e})));return q`
    ...
    `}};t([pe({attribute:!1})],Ve.prototype,"hass",void 0),t([fe()],Ve.prototype,"_config",void 0),t([fe()],Ve.prototype,"_areas",void 0),t([fe()],Ve.prototype,"_localImages",void 0),Ve=t([de("area-card-elite-editor")],Ve),customElements.get(e)||customElements.define(e,Ne),customElements.get(e+"-editor")||customElements.define(e+"-editor",Ve),window.customCards=window.customCards||[],window.customCards.push({type:e,name:"Area Card Elite",description:"An enhanced area card for Home Assistant"})}();
