      ...
      <ha-card class="${this._config.display_type||"compact"} layout-${n} features-${a}">
        <div class="content">
          ...
          ${"icon"===this._config.display_type&&c?F`
            <div class="main-entity-background ${!l||Te.includes(l.state)||Me.includes(l.state)||"unlocked"===l.state?"":"active"} 
