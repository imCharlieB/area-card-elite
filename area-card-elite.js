      ...
      <ha-card class="${this._config.display_type||"compact"} layout-${l} features-${c}" style=${r}>
        <div class="content">
          ...
          ${"icon"===this._config.display_type&&h?F`
            ...
            <div class="main-entity-circle ${this._isEntityActive(h)?"active":"inactive"} ${this._hasActiveAlerts()?"has-alert":""}">
            </div>
