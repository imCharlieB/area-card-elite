...
/**
    ...
    `:q}_handleControlClick(e){this._handleEntityClick(e)}_handleEntityClick(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}_getAreaCameras(){var e;return(null===(e=this._config)||void 0===e?void 0:e.area)?Object.entries(this.hass.states||{}).filter((([e,t])=>{var i,o;const[s]=e.split(".");return"camera"===s&&(null===(i=t.attributes)||void 0===i?void 0:i.area_id)===(null===(o=this._config)||void 0===o?void 0:o.area)})).map((([e,t])=>({entityId:e,name:t.attributes.friendly_name||e.split(".")[1]}))):[]}_getAreaName(){var e,t,i;if(null===(e=this._config)||void 0===e?void 0:e.name)return this._config.name;const o=this._areas[(null===(t=this._config)||void 0===t?void 0:t.area)||""];return(null==o?void 0:o.name)||(null===(i=this._config)||void 0===i?void 0:i.area)||"Unknown Area"}_getOccupancyCount(){var e;if(!(null===(e=this._config)||void 0===e?void 0:e.area))return 0;if(this._config.occupancy_sensor&&this.hass.states[this._config.occupancy_sensor]){const e=this.hass.states[this._config.occupancy_sensor];if(!De.includes(e.state)&&Fe.includes(e.state))return 1}const t=this._getAreaEntities();let i=0;return t.forEach((e=>{if("person"===e.domain||"device_tracker"===e.domain){const t=(this.hass.states[e.entityId]||{}).state;t&&!De.includes(t)&&Fe.includes(t)&&(i+=1)}})),i}_getAreaIcon(){var e,t;if(null===(e=this._config)||void 0===e?void 0:e.icon)return this._config.icon;const i=this._areas[(null===(t=this._config)||void 0===t?void 0:t.area)||""];return(null==i?void 0:i.icon)||"mdi:home"}_getAreaFilteredEntities(e,t){var i;return(null===(i=this._config)||void 0===i?void 0:i.area)?Object.entries(this.hass.states||{}).filter((([i,o])=>{var s,a;const[n]=i.split(".");return n===e&&((!t||o.attributes.device_class===t)&&(null===(s=o.attributes)||void 0===s?void 0:s.area_id)===(null===(a=this._config)||void 0===a?void 0:a.area))})).map((([e])=>e)):[]}_isEntityActive(e){var t;if(!e)return!1;const i=e.entity_id.split(".")[0];if(De.includes(e.state))return!1;if("lock"===i)return"locked"===e.state;if("binary_sensor"===i){const i=null===(t=e.attributes)||void 0===t?void 0:t.device_class;if("door"===i||"window"===i||"opening"===i)return"off"===e.state||"closed"===e.state}return"cover"===i?"closed"===e.state:!Be.includes(e.state)}render(){var e;if(!this.hass||!this._config)return q;const t=this._getAreaName(),i=this._getAreaIcon(),o=this._config.area_name_color?`color: ${this._config.area_name_color};`:"",s=this._config.area_icon_color?`color: ${this._config.area_icon_color};`:"",a={active:{color:(null==(n=this._config)?void 0:n.state_active_color)||"#4caf50",rgb:Ne((null==n?void 0:n.state_active_color)||"#4caf50")},inactive:{color:(null==n?void 0:n.state_inactive_color)||"#607d8b",rgb:Ne((null==n?void 0:n.state_inactive_color)||"#607d8b")}};var n;const r=this._getActiveAlertInfo();let c,l;if(this._config.temperature_entity&&this.hass.states[this._config.temperature_entity]){const e=this.hass.states[this._config.temperature_entity].state;c=parseFloat(e),isNaN(c)&&(c=void 0)}if(this._config.humidity_entity&&this.hass.states[this._config.humidity_entity]){const e=this.hass.states[this._config.humidity_entity].state;l=parseFloat(e),isNaN(l)&&(l=void 0)}const d=Le(c),h=function(e){return null==e?.15:e>=70?.25:e>=60?.2:e>=40?.15:.12}(l),u=$e(Object.assign({"--state-active-color":a.active.color,"--state-active-rgb":a.active.rgb,"--state-inactive-color":a.inactive.color,"--state-inactive-rgb":a.inactive.rgb,"--alert-color":r.color,"--alert-rgb":r.rgb,"--temp-color":d.color,"--temp-rgb":d.rgb,"--humidity-intensity":h.toString()},this._config.color&&{backgroundColor:this._config.color})),f=this._getOccupancyCount(),p=f>0,g=He("occupancy",this._config).color,m=this._config.layout||"compact",_=this._config.features_position||"bottom",v=null===(e=this._config.features)||void 0===e?void 0:e.includes("area-controls"),y=this._config.main_entity?this.hass.states[this._config.main_entity]:null;return F`
      <ha-card class="${this._config.display_type||"compact"} layout-${m} features-${_}${p?" occupied":""}" style=${u}>
        <div class="content">
          <!-- Large background entity icon - ONLY for icon display type -->
          ${"icon"===this._config.display_type&&y?F`
            <!-- Separate circle background -->
            <div class="main-entity-circle ${this._isEntityActive(y)?"active":"inactive"} ${this._hasActiveAlerts()?"has-alert":""}">
            </div>
            ...
            <div class="main-entity-icon"
              ...
              <ha-icon
                icon="${this._getDomainIcon(y.entity_id.split(".")[0],y.state,y.attributes.device_class)}">
              </ha-icon>
            </div>
          `:q}
          ...
          <div class="area-info">
            ${"vertical"===m||"compact"!==this._config.display_type?F`
            ...
            <div class="area-details">
              <div class="area-name" style="${o}">
                ...
                ${t}
                ${p?F`
                  <span class="occupancy" title="${f} present">
                    <ha-icon
                      icon="${f>1?"mdi:account-multiple":"mdi:account"}"
                      style="color: ${g}; --mdc-icon-size: 16px;"
                    ></ha-icon>
                    ${f>1?F`<span class="occupancy-count">${f}</span>`:q}
                  </span>
                `:q}
              </div>
  ...
  `,t([fe({attribute:!1})],We.prototype,"hass",void 0),t([pe()],We.prototype,"_config",void 0),t([pe()],We.prototype,"_areas",void 0),We=t([de("area-card-elite")],We),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(qe||(qe={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(Ye||(Ye={}));var Ke=function(e,t,i,o){o=o||{},i=null==i?{}:i;var s=new Event(t,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});return s.detail=i,e.dispatchEvent(s),s};let Ge=class extends ce{constructor(){super(...arguments),this._areas=[],this._localImages=[],this._entities=[],this._devices=[]}async connectedCallback(){super.connectedCallback(),await this._loadAreas(),await this._loadLocalImages(),await this._loadEntityRegistry(),await this._loadDeviceRegistry()}async _loadAreas(){var e;try{if(null===(e=this.hass)||void 0===e?void 0:e.connection){const e=await this.hass.connection.sendMessagePromise({type:"config/area_registry/list"});this._areas=e||[]}}catch(e){console.error("Failed to load areas:",e),this._areas=[]}}async _loadEntityRegistry(){var e;try{(null===(e=this.hass)||void 0===e?void 0:e.connection)&&(this._entities=await this.hass.connection.sendMessagePromise({type:"config/entity_registry/list"}))}catch(e){console.error("Failed to load entity registry:",e),this._entities=[]}}async _loadDeviceRegistry(){var e;try{(null===(e=this.hass)||void 0===e?void 0:e.connection)&&(this._devices=await this.hass.connection.sendMessagePromise({type:"config/device_registry/list"}))}catch(e){console.error("Failed to load device registry:",e),this._devices=[]}}async _loadLocalImages(){try{const e=await this.hass.connection.sendMessagePromise({type:"media_player/browse_media",media_content_id:"media-source://media_source/local",media_content_type:"app"});this._localImages=this._extractImagePaths(e)}catch(e){console.error("Failed to load local images:",e),this._localImages=[]}}_extractImagePaths(e){const t=[];return(null==e?void 0:e.children)&&e.children.forEach((e=>{var i,o;if(null===(i=e.media_content_type)||void 0===i?void 0:i.startsWith("image/")){const i=null===(o=e.media_content_id)||void 0===o?void 0:o.replace("media-source://media_source/local/","/local/");i&&t.push(i)}})),t}setConfig(e){this._config=Object.assign({features:[],display_type:"compact",color:"",aspect_ratio:"16:9",camera_view:"auto",navigation_path:"",alert_classes:[],sensor_classes:[],features_position:"bottom",exclude_entities:[],layout:"vertical"},e)}_valueChanged(e){var t;if(e.stopPropagation(),!this._config)return;const i=e.target;let o=null===(t=e.detail)||void 0===t?void 0:t.value,s=i.configValue;console.log("Value changed:",{type:e.type,tagName:i.tagName,configValue:s,value:o,detail:e.detail}),null==o&&("input"===e.type&&void 0!==i.value||void 0!==i.value)&&(o=i.value),"HA-AREA-PICKER"===i.tagName?s="area":"HA-ENTITY-PICKER"===i.tagName&&(s=i.configValue||"exclude_entities"),s&&void 0!==o&&(console.log("Setting config:",s,"=",o),this._config=Object.assign(Object.assign({},this._config),{[s]:o}),Ke(this,"config-changed",{config:this._config}),this.requestUpdate())}_getDeviceClasses(e){var t;if(!(null===(t=this._config)||void 0===t?void 0:t.area))return[];const i=Object.entries(this.hass.states||{}).filter((([t,i])=>{var o,s;return!!(null===(o=i.attributes)||void 0===o?void 0:o.area_id)&&(i.attributes.area_id===(null===(s=this._config)||void 0===s?void 0:s.area)&&t.split(".")[0]===e)})).map((([e,t])=>t)),o=i.map((e=>e.attributes.device_class||"")).filter((e=>e));return[...new Set(o)]}_buildSelectOptions(e){const t=this._getDeviceClasses(e);let i=[];return i="binary_sensor"===e?[...new Set([...t,...Re.binary_sensor])]:"sensor"===e?[...new Set([...t,...Re.sensor])]:t,i.map((t=>({value:t,label:this.hass.localize(`component.${e}.device_class.${t}`)||this.hass.localize(`ui.dialogs.entity_registry.editor.device_classes.${e}.${t}`)||t.charAt(0).toUpperCase()+t.slice(1).replace(/_/g," ")})))}_getAreaCameras(){var e;if(!(null===(e=this._config)||void 0===e?void 0:e.area))return[];const t=Object.keys(this.hass.states||{}).filter((e=>{var t,i,o,s;const[a]=e.split(".");if("camera"!==a)return!1;if((null===(t=this.hass.states[e].attributes)||void 0===t?void 0:t.area_id)===(null===(i=this._config)||void 0===i?void 0:i.area))return!0;const n=this._entities.find((t=>t.entity_id===e));if((null==n?void 0:n.area_id)===(null===(o=this._config)||void 0===o?void 0:o.area))return!0;if(null==n?void 0:n.device_id){const e=this._devices.find((e=>e.id===n.device_id));if((null==e?void 0:e.area_id)===(null===(s=this._config)||void 0===s?void 0:s.area))return!0}return!1}));return t}render(){return this.hass&&this._config?(this._buildSelectOptions("binary_sensor"),F`
    ...
    `}};t([fe({attribute:!1})],Ge.prototype,"hass",void 0),t([pe()],Ge.prototype,"_config",void 0),t([pe()],Ge.prototype,"_areas",void 0),t([pe()],Ge.prototype,"_localImages",void 0),t([pe()],Ge.prototype,"_entities",void 0),t([pe()],Ge.prototype,"_devices",void 0),Ge=t([de("area-card-elite-editor")],Ge),customElements.get(e)||customElements.define(e,We),customElements.get(e+"-editor")||customElements.define(e+"-editor",Ge),window.customCards=window.customCards||[],window.customCards.push({type:e,name:"Area Card Elite",description:"An enhanced area card for Home Assistant"})}();
